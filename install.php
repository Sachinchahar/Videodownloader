...
<form method="post" class="form-signin">
    ...
    if (@$_POST) {
        ...
        $response = array('url' => $site_url, 'language' => $lang, 'template' => $template, 'purchase_code' => $purchase_code, 'version' => '1.6.3', 'title' => $title, 'description' => $description, 'author' => $author, 'email' => $email, 'download_suffix' => null, 'fingerprint' => $fingerprint);
